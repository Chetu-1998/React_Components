...
const SideBarCardComponent = () => {
    return (
        <div className="min-h-screen bg-red-100">
            <div className="sidebar min-h-screen w-[3.80rem] overflow-hidden border-r hover:w-96 hover:bg-red-500 hover:shadow-lg duration-500 delay-300">
                        ...
                        <ul className="mt-6 space-y-3 tracking-wide">
                            <li className="min-w-max">
                                <a href="#" aria-label="About" className="flex items-center space-x-4 hover:bg-black px-4 py-3  text-white">
                                    ...
                                    <span className="font-medium transition duration-500">About</span>
                                </a>
                            </li>
                            <li className="min-w-max">
